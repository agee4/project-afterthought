...
const EmailIcon = <svg className="inline-block h-4 align-baseline fill-black dark:fill-white hover:fill-indigo-500" version="1.1" baseProfile="tiny" id="Layer_1" xmlns:x="http://ns.adobe.com/Extensibility/1.0/" xmlns:i="http://ns.adobe.com/AdobeIllustrator/10.0/" xmlns:graph="http://ns.adobe.com/Graphs/1.0/" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" xmlns:a="http://ns.adobe.com/AdobeSVGViewerExtensions/3.0/" viewBox="-0.5 0.5 42 42" xmlSpace="preserve">
...
const GitHubIcon = <svg className="inline-block h-4 align-baseline fill-black dark:fill-white hover:fill-indigo-500 stroke-black dark:stroke-white group-hover:stroke-indigo-500" version="1.0" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 240.000000 240.000000" preserveAspectRatio="xMidYMid meet">
...
const LinkedInIcon = <svg  className="inline-block h-4 align-baseline fill-black dark:fill-white hover:fill-indigo-500" viewBox="0 0 24 24" role="img" xmlns="http://www.w3.org/2000/svg"><title>LinkedIn icon</title><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/></svg>
...
const ReferenceFooter = () => {
  ...
  return (
    <footer className="justify-between bg-neutral-100 py-2 text-sm text-neutral-700 shadow-md dark:bg-neutral-900 dark:text-neutral-300">
      <nav className="flex flex-row justify-evenly flex-wrap">
        <menu>
          <li>
            <h1>
              <Link
          ...
          <span className="flex flex-col sm:flex-row justify-evenly">
            ...
            <li>
              <Link
                ...
                className="content-[''] hover:after:bg-indigo-500 w-full h-full hover:after:mix-blend-multiply"
              >
                {GitHubIcon}
              </Link>
            </li>
