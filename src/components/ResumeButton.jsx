...
const DownloadIcon =
<svg className="inline-block h-3 align-baseline fill-none stroke-black dark:stroke-white group-hover:stroke-indigo-500" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
...
const ResumeButton = (props) => {
  ...
  return (
    <button
      className={ "group cursor-pointer font-medium transition-colors duration-200 whitespace-nowrap hover:text-indigo-500 " +
        (props.className
          ? props.className
