...
const ThanksPage = () => (
  <Page title="Special Thanks">
    ...
    <h2 className="m-3 text-3xl font-bold">Aaron Tong</h2>
    <p>For suggesting dropdown menus to close when clicked off of</p>
    <h2 className="m-3 text-3xl font-bold">Jacob Yeh</h2>
    <p>For suggesting image enlarging/modal images</p>
    <h2 className="m-3 text-3xl font-bold">Isaac Koo</h2>
    <p>For introducing the basics of TailwindCSS to me</p>
    <h2 className="m-3 text-3xl font-bold">Modrinth</h2>
    <p>
      For giving me the inspiration of having an "infinitely looping" gallery
    </p>
  </Page>
)
