...
const ResumePage = () => <Page title="Overview">
  ...
  <p>Prototyped low-cost semi-autonomous aerial drone with fire detection capabilities using Python.
Developed the drone’s fire detecting program by combining image processing techniques, non-neural object detection, and thermal imagery to accurately identify the presence of fires. I also effectively communicated software-oriented ideas and plans to teammates unfamiliar with software topics to more efficiently develop better prototypes that were both accurate and inexpensive.
</p>
  <h3 className="m-1 text-xl font-bold">Ride Organizer App</h3>
  <p>Created a web-based ride organizing application. Produced a user-friendly frontend website using React, and a stable backend using NodeJS and MongoDB.</p>
  <h3 className="m-1 text-xl font-bold">Portfolio Website</h3>
  <p>Created a project portfolio website. Produced a user-friendly frontend website using React and Tailwind.</p>
