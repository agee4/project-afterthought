...
const ProjectsPage = () => (
  <Page title="Projects Home">
    ...
    <p>
      <Link className="hover:text-indigo-500" to="../projects/ride-organizer">
        Ride Organizer
      </Link>
    </p>
    <p>
      <Link className="hover:text-indigo-500" to="../projects/fire-detector">
        Fire Detector
      </Link>
    </p>
    <h2 className="m-3 text-3xl font-bold">Present Projects</h2>
    <p>
      <Link className="hover:text-indigo-500" to="../projects/portfolio-site">
        Portfolio Website
      </Link>
    </p>
