...
const RideOrganizerPage = () => (
  <Page title="Ride Organizer">
    ...
    <p className="px-5">
      ...
      was to create a fullstack internet application with the purpose of helping
      ride coordinators assign a large amount of passengers to various drivers,
