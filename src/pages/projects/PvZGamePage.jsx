...
const PvZGamePage = () => (
  <Page title="Plants vs. Zombies Fan Game">
    ...
    <p className="px-5">
      ...
      the 2009 tower defense game <i>Plants vs. Zombies</i> and its 2013 sequel{" "}
      <i>Plants vs. Zombies 2: It's About Time</i>. It incorporates familiar
      elements of the official series, such as a grid-based arena and sun costs,
      while introducing new mechanics that aim to compliment and enhance the
      gameplay experience.
    </p>
    ...
    <ul className="px-5">
      ...
      <li>
        No longer will you have to risk growing your precious plants out on the
        dangerous battlefield! Plants can now be directly grown in a zombie-free
        greenhouse, allowing you to further plan out your dendritic defenses in
        advance!
      </li>
      ...
      <li>
        ...
        whole new cast of botanical buddies are waiting to help keep your brains
        in your head!
        <br />
        <span className="text-orange-500">Bow n Carrow</span> shoot pointy
        carrots at the highest-health zombie in their lane, taking out slow and
        bulky targets.
        <br />
