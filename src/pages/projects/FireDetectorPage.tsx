  ...
  return (
    <Page title="Fire Detector">
      ...
      <p className="px-5">
        ...
        undergraduate Capstone project that begun Spring of 2023 and was
        completed Winter of 2024. The final product was a semiautonomous aerial
        drone equipped with various sensors that it could use to identify fires.
